...
基于一个不可测量的基本认识，我们就会更注重在合理的范围，通过合理的定义去讨论问题，更加重视前提条件和适用性。
...
How many machine learning do we need?
-------------------------------------

21世纪，机器学习与人工智能得到了快速的发展，这种发展对各个领域都产生了深刻的影响。对于科研领域，越来越多的机器学习方法被用在各个领域。在我们这个学科，很多人尝到了甜头，使用深度学习做预测，做回归，根据图像分析指数。我并不排斥这些方法，相反，主动深入的学习了很多机器学习方法。

但是，一些人陷入了盲目乐观，认为机器学习是万能的，任何的研究问题，只要使用机器学习方法，都能得以解决；或者认为使用机器学习方法就能很快的发表论文。有时候我也难免陷入了这种想法。

这种想法是一种什么样的判断呢，现实世界太过复杂，

python的发展极大地简化了我们学习和使用代码的成本，他把一个个函数封装成了工具，但是这并不意味着我们仅仅使用它，而不用拆开箱子看看里面装的到底是什么，而只关注我看到写的代码，基本的循环。什么是学会呢？有些人觉得学会了使用python基础就是学会了机器学习，这就像是，学会加法就是学会了积分。
$$
1+1 =2\
1*2 = 1+1 =2\
add(1,1) =2 \
...
integral(1,2)= 2
$$
不管什么样的问题，只要把数据整理成输入的样子，丢到模型里，总会有个结果出来，只要这个结果精度高，就称得上是研究成果了。

这种科研的方式，真是对科学研究本身的讽刺。如果科学变成了不重视逻辑，只追求精度的游戏，将会非常危险。对于精度的追求导致了对更专业的工作的莫不关心，对现实情况。

我们应该问一些更本质的问题。精度的提高来源于什么，是非线性关系带来的吗？

口渴的乌鸦与会说话的鹦鹉，哪个更聪明？ 


.. image:: http://www.zzzhou.me/images/2020/11/12/pastedimage0.png
   :target: http://www.zzzhou.me/images/2020/11/12/pastedimage0.png
   :alt: pasted image 0


在\ *伊索寓言中*\ ，口渴的乌鸦在水底发现了一个水罐。水是喙所不能及的。它故意将小石子丢入水罐，导致水上升到顶部。会说话的鹦鹉不能真正说话。在无数次被用上简单的短语（大数据和机器学习）之后，它只能模仿语音而无法理解其含义。

https://medium.com/@GaryMarcus/the-deepest-problem-with-deep-learning-91c5991f5695

深度学习令人讨厌的地方在于它没有可证明的局限性，如果我们给它更多的时间和更多的数据，它本身可能会使我们进入通用智能，

当一个领域试图扼杀批评家，而不是解决潜在的批评，以政治代替科学探究时，某些事情已经严重失踪了。这就是一种机器智能而不是人的智能。

盲目崇拜的情绪与科学理性相违背

掌握算力就掌握了科学，换个更好的电脑就能解决问题
